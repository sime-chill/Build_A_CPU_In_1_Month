...
#define HAVE_mulsidi3_32bit (!TARGET_64BIT && ((!TARGET_FIX_R4000 && ISA_HAS_MULT) || ISA_HAS_DSP))
#define HAVE_umulsidi3_32bit (!TARGET_64BIT && ((!TARGET_FIX_R4000 && ISA_HAS_MULT) || ISA_HAS_DSP))
...
#define HAVE_msubsidi4 (!TARGET_64BIT && (ISA_HAS_MSAC || ISA_HAS_DSP_MULT || GENERATE_MADD_MSUB))
#define HAVE_umsubsidi4 (!TARGET_64BIT && (ISA_HAS_MSAC || ISA_HAS_DSP_MULT || GENERATE_MADD_MSUB))
...
#define HAVE_maddsidi4 ((TARGET_MAD || ISA_HAS_MACC || ISA_HAS_DSP_MULT || GENERATE_MADD_MSUB) \
   && !TARGET_64BIT)
#define HAVE_umaddsidi4 ((TARGET_MAD || ISA_HAS_MACC || ISA_HAS_DSP_MULT || GENERATE_MADD_MSUB) \
   && !TARGET_64BIT)
#define HAVE_fmasf4 ((ISA_HAS_FP_MADDF_MSUBF) && (TARGET_HARD_FLOAT))
#define HAVE_fmadf4 ((ISA_HAS_FP_MADDF_MSUBF) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_fmav2sf4 ((ISA_HAS_FP_MADDF_MSUBF) && (TARGET_HARD_FLOAT && TARGET_PAIRED_SINGLE_FLOAT))
...
#define HAVE_mov_ldr (((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
   && mips_mem_fits_mode_p (DImode, operands[1])) && (TARGET_64BIT))
#define HAVE_mov_swl ((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
   && mips_mem_fits_mode_p (SImode, operands[0]))
#define HAVE_mov_sdl (((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
   && mips_mem_fits_mode_p (DImode, operands[0])) && (TARGET_64BIT))
#define HAVE_mov_swr ((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
   && mips_mem_fits_mode_p (SImode, operands[0]))
#define HAVE_mov_sdr (((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
   && mips_mem_fits_mode_p (DImode, operands[0])) && (TARGET_64BIT))
#define HAVE_load_gotsi (Pmode == SImode)
#define HAVE_load_gotdi (Pmode == DImode)
#define HAVE_mips16_copy_ofs (ISA_HAS_COPY)
...
#define HAVE_clear_hazard_ur6_si ((ISA_HAS_SYNCI && TARGET_MICROMIPS_R6) && (Pmode == SImode))
#define HAVE_clear_hazard_ur6_di ((ISA_HAS_SYNCI && TARGET_MICROMIPS_R6) && (Pmode == DImode))
#define HAVE_clear_hazard_r6_si ((ISA_HAS_SYNCI && ISA_HAS_R6MUL && !TARGET_MICROMIPS_R6) && (Pmode == SImode))
#define HAVE_clear_hazard_r6_di ((ISA_HAS_SYNCI && ISA_HAS_R6MUL && !TARGET_MICROMIPS_R6) && (Pmode == DImode))
...
#define HAVE_return_epi_internal 1
...
#define HAVE_join2_load_storehi (ENABLE_LD_ST_PAIRS \
   && mips_load_store_bonding_p (operands, HImode))
#define HAVE_join2_load_storesi (ENABLE_LD_ST_PAIRS \
   && mips_load_store_bonding_p (operands, SImode))
#define HAVE_join2_load_storedi ((ENABLE_LD_ST_PAIRS \
   && mips_load_store_bonding_p (operands, DImode)) && (TARGET_64BIT))
#define HAVE_join2_load_storesf ((ENABLE_LD_ST_PAIRS \
   && mips_load_store_bonding_p (operands, SFmode)) && (TARGET_HARD_FLOAT))
#define HAVE_join2_load_storedf ((ENABLE_LD_ST_PAIRS \
   && mips_load_store_bonding_p (operands, DFmode)) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
...
#define HAVE_msa_fmadd_d (ISA_HAS_MSA)
#define HAVE_msa_fmadd_w (ISA_HAS_MSA)
#define HAVE_msa_fmsub_d (ISA_HAS_MSA)
#define HAVE_msa_fmsub_w (ISA_HAS_MSA)
...
#define HAVE_umaxv2df3 (ISA_HAS_MSA)
#define HAVE_umaxv4sf3 (ISA_HAS_MSA)
#define HAVE_sminv2df3 (ISA_HAS_MSA)
#define HAVE_sminv4sf3 (ISA_HAS_MSA)
#define HAVE_uminv2df3 (ISA_HAS_MSA)
#define HAVE_uminv4sf3 (ISA_HAS_MSA)
...
#define HAVE_extvmisalignsi (ISA_HAS_LWL_LWR || ISA_HAS_MIPS16E2)
#define HAVE_extvmisaligndi ((ISA_HAS_LWL_LWR || ISA_HAS_MIPS16E2) && (TARGET_64BIT))
#define HAVE_extvsi (ISA_HAS_EXTS)
#define HAVE_extvdi ((ISA_HAS_EXTS) && (TARGET_64BIT))
#define HAVE_extzvmisalignsi (ISA_HAS_LWL_LWR || ISA_HAS_MIPS16E2)
#define HAVE_extzvmisaligndi ((ISA_HAS_LWL_LWR || ISA_HAS_MIPS16E2) && (TARGET_64BIT))
#define HAVE_extzvsi 1
#define HAVE_extzvdi (TARGET_64BIT)
#define HAVE_insvmisalignsi (ISA_HAS_LWL_LWR || ISA_HAS_MIPS16E2)
#define HAVE_insvmisaligndi ((ISA_HAS_LWL_LWR || ISA_HAS_MIPS16E2) && (TARGET_64BIT))
...
#define HAVE_movdi 1
#define HAVE_mips16_copy (ISA_HAS_COPY)
#define HAVE_movsi 1
...
#define HAVE_movmemsi ((!TARGET_MIPS16 || ISA_HAS_COPY) && !TARGET_MEMCPY)
...
#define HAVE_movv2df (TARGET_MSA)
#define HAVE_movv4sf (TARGET_MSA)
#define HAVE_movv2di (TARGET_MSA)
#define HAVE_movv4si (TARGET_MSA)
#define HAVE_movv8hi (TARGET_MSA)
#define HAVE_movv16qi (TARGET_MSA)
#define HAVE_movmisalignv2df (TARGET_MSA)
#define HAVE_movmisalignv4sf (TARGET_MSA)
#define HAVE_movmisalignv2di (TARGET_MSA)
#define HAVE_movmisalignv4si (TARGET_MSA)
#define HAVE_movmisalignv8hi (TARGET_MSA)
#define HAVE_movmisalignv16qi (TARGET_MSA)
...
extern rtx        gen_mips16_copy_ofs                 (rtx, rtx, rtx, rtx, rtx);
...
extern rtx        gen_clear_hazard_ur6_si             (void);
extern rtx        gen_clear_hazard_ur6_di             (void);
extern rtx        gen_clear_hazard_r6_si              (void);
extern rtx        gen_clear_hazard_r6_di              (void);
...
extern rtx        gen_return_epi_internal             (rtx, rtx);
...
extern rtx        gen_join2_load_storehi              (rtx, rtx, rtx, rtx);
extern rtx        gen_join2_load_storesi              (rtx, rtx, rtx, rtx);
extern rtx        gen_join2_load_storedi              (rtx, rtx, rtx, rtx);
extern rtx        gen_join2_load_storesf              (rtx, rtx, rtx, rtx);
extern rtx        gen_join2_load_storedf              (rtx, rtx, rtx, rtx);
...
extern rtx        gen_msa_fmadd_d                     (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_fmadd_w                     (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_fmsub_d                     (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_fmsub_w                     (rtx, rtx, rtx, rtx);
...
extern rtx        gen_mips16_copy                     (rtx, rtx, rtx, rtx, rtx);
