/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/scratch/mpf/jobs/54395/48094/240198/shared/gcc/gcc/config/mips/mips.md'.  */
...
extern int const_immlsa_operand (rtx, enum machine_mode);
extern int const_msa_branch_operand (rtx, enum machine_mode);
...
extern int const_imm5_operand (rtx, enum machine_mode);
extern int const_imm10_operand (rtx, enum machine_mode);
extern int reg_imm10_operand (rtx, enum machine_mode);
extern int aq10b_operand (rtx, enum machine_mode);
extern int aq10h_operand (rtx, enum machine_mode);
extern int aq10w_operand (rtx, enum machine_mode);
extern int aq10d_operand (rtx, enum machine_mode);
...
extern int reg_or_0_operand_mips16e2 (rtx, enum machine_mode);
extern int const_1_operand (rtx, enum machine_mode);
extern int reg_or_1_operand (rtx, enum machine_mode);
extern int const_exp_2_operand (rtx, enum machine_mode);
extern int const_exp_4_operand (rtx, enum machine_mode);
extern int const_exp_8_operand (rtx, enum machine_mode);
extern int const_exp_16_operand (rtx, enum machine_mode);
...
extern int const_sibcall_insn_operand (rtx, enum machine_mode);
...
extern int const_vector_same_ximm5_operand (rtx, enum machine_mode);
extern int const_vector_same_uimm5_operand (rtx, enum machine_mode);
extern int const_vector_same_uimm6_operand (rtx, enum machine_mode);
extern int const_vector_same_uimm8_operand (rtx, enum machine_mode);
extern int const_vector_same_cmpsimm4_operand (rtx, enum machine_mode);
extern int const_vector_same_cmpuimm4_operand (rtx, enum machine_mode);
extern int const_vector_same_v2di_set_operand (rtx, enum machine_mode);
extern int const_vector_same_v2di_clr_operand (rtx, enum machine_mode);
extern int const_vector_same_v4si_set_operand (rtx, enum machine_mode);
extern int const_vector_same_v4si_clr_operand (rtx, enum machine_mode);
extern int const_vector_same_v8hi_set_operand (rtx, enum machine_mode);
extern int const_vector_same_v8hi_clr_operand (rtx, enum machine_mode);
extern int const_vector_same_v16qi_set_operand (rtx, enum machine_mode);
extern int const_vector_same_v16qi_clr_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_byte_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_ximm5_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_uimm6_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v2di_set_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v2di_clr_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v4si_set_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v4si_clr_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v8hi_set_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v8hi_clr_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v16qi_set_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_v16qi_clr_operand (rtx, enum machine_mode);
